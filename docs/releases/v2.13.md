# Release Notes - Replicate Seamless Support & File Preview Fix

## Version: v2.13.4 Replicate seamless support
**Release Date:** 2025-11-12
**Base:** v2.13
**Highlights:** Integrate Replicate as a first-class, prediction-based provider in the Image Agent pipeline, add ready-to-use Replicate model presets, and stabilize file preview behavior via ExpandableDialog.
